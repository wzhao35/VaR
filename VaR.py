...
class User:
    def __init__(self, master):
        ...
        self.locator_label1 = Label(
            frame,
            text="Choose methodology (1 as historical simulation, 2 as parametric VaR):",
            width=100,
            height=2)
        self.locator_label2 = Label(
            frame,
            text="Enter confidence interval(%):",
            width=100,
            height=2)
        self.locator_label3 = Label(
            frame,
